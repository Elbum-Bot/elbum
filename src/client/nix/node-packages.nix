...
let
  sources = {
    ...
    "elm-review-2.11.2" = {
      ...
      version = "2.11.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/elm-review/-/elm-review-2.11.2.tgz";
        sha512 = "FhZ/m59C9CPWgn34/yvGUoCsSmXDnFFR2GfmuFbcnRwcn2aybsOUav5ET2lXs+4V1zZMRTG6In8cCUooAhwHVg==";
      };
    };
